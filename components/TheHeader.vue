...
const isFavorited = () => {
  if (user.value.username) navigateTo({ name: 'products-favorited', query: { f: user.value.username } })
}
...
onMounted(() => console.log(productsByFavorited.value))
</script>
        ...
        <div class="navbar-content">
          <div class="icon-block">
            ...
            <NuxtLink to="/category/bad-i-produkty-funkcionalnogo-pitaniya">
              <div class="btn catalog-btn" @click="activeCategoryChain=[]">
          ...
          <div class="icon-one">
            ...
            <svg width="26px" height="26px" viewBox="0 0 22 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
